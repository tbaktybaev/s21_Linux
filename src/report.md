...
- Время установилось на зону Европа/Москва
...
- IP-адрес по умолчанию: 195.133.239.85
...
- Статичные настройки заданы с помощью `ifconfig`, `route add default` и `echo >`
